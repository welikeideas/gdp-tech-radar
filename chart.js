...
exports.build = function(docs, title, group, url, filter) {

    var spanBoundaries = findSpanBoundaries(docs);
    var maxSpan = spanBoundaries.pop();
    var minSpan = spanBoundaries.pop();

    var list = {items:[],areas:[],title:title,group:group,statuses:{assess:0,trial:0,use:0,hold:0,retire:0},isLink:true,url:url};
    var areaCheck = [];
